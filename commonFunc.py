...
def IOU(bboxPred, bboxLabel):
    box1_x1 = bboxPred[..., 0:1] - (bboxPred[..., 2:3] / 2)
    box1_y1 = bboxPred[..., 1:2] - (bboxPred[..., 3:4] / 2)
    box1_x2 = bboxPred[..., 0:1] + (bboxPred[..., 2:3] / 2)
    box1_y2 = bboxPred[..., 1:2] + (bboxPred[..., 3:4] / 2)
    box2_x1 = bboxLabel[..., 0:1] - (bboxLabel[..., 2:3] / 2)
    box2_y1 = bboxLabel[..., 1:2] - (bboxLabel[..., 3:4] / 2)
    box2_x2 = bboxLabel[..., 0:1] + (bboxLabel[..., 2:3] / 2)
    box2_y2 = bboxLabel[..., 1:2] + (bboxLabel[..., 3:4] / 2)

    x1 = torch.max(box1_x1, box2_x2)
...
def non_max_suppression(bboxes, iou_threshold, threshold):
    ...
    while bboxes:
        ...
        bboxes = [
            ...
            or IOU(torch.tensor(chosen_box[2:]),torch.tensor(box[2:]),)
               < iou_threshold
        ]
...
def convert_cellboxes(predictions, S=7, C=6):
    """
